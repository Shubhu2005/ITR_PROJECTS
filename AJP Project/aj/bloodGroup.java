...
public class bloodGroup extends JFrame implements ActionListenerthrows ClassNotFoundException

{
	...
	public bloodGroup()
	{
		...
		l1=new JLabel("Search Donor By Blood Group");
		l1.setFont(new Font("Tahoma", Font.BOLD, 60));
		l1.setBounds(150,50,1000,100);
		add(l1);
		
		l2=new JLabel("Enter Blood Group");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(s.equals("Search"))
		{
			...
			try
			{
				...
				PreparedStatement ps = co.prepareStatement("select * from donor where bloodg=?");
				ps.setString(1,tt1);
